...
# classifier = svm.SVC(kernel="sigmoid")  # also try kernel="poly", kernel="rbf", kernel="linear"
...
for i in range(testingSize-1):
    print("Prediction: ", classifier.predict(testSamples[i].reshape(1, -1)), " Actual Value: ", testLabels[i])
