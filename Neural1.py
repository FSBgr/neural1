...
class Net(nn.Module):
    def __init__(self):
        ...
        '''self.fc1 = nn.Linear(28 * 28, 128)  # 28 by 28 picture input
        self.fc2 = nn.Linear(128, 128)  # input is 64 since previous layer output is 64
        self.fc3 = nn.Linear(128, 128)
        self.fc4 = nn.Linear(128, 10)  # Last layer output is 10, for the 10 single digit numbers'''

        self.fc1 = nn.Linear(28 * 28, 32)  # 28 by 28 picture input
        self.fc2 = nn.Linear(32, 32)  # input is 64 since previous layer output is 64
        self.fc3 = nn.Linear(32, 32)
        self.fc4 = nn.Linear(32, 10)  # Last layer output is 10, for the 10 single digit numbers
